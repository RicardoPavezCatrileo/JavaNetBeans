...
public class ManejoPersonas {
    public static void main(String[] args) {
	  ...
	  //Creamos el objeto PersonasJDBC - proporcionamos la conexion creada
            PersonasJDBC personas = new PersonasJDBC(conn);
            //empezamos a ejecutar sentencias, recordar que una transaccion agrupa varias
            //sentencias SQL si algo falla no se realizan los cambios en la BD cambio correcto
            personas.update(2, "Regreso2", "Regreso");
            //Provocamos un error superando los 45 caracteres del campo de apellido
